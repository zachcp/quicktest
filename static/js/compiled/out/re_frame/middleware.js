...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__19238){
...
return cljs.core.get_in.call(null,new_db,p1__19239_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__19240_SHARP_){
return cljs.core.get_in.call(null,db,p1__19240_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__19241__i < G__19241__a.length) {G__19241__a[G__19241__i] = arguments[G__19241__i + 2]; ++G__19241__i;}
  in_paths = new cljs.core.IndexedSeq(G__19241__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__19242){
var f = cljs.core.first(arglist__19242);
arglist__19242 = cljs.core.next(arglist__19242);
var out_path = cljs.core.first(arglist__19242);
var in_paths = cljs.core.rest(arglist__19242);
...
//# sourceMappingURL=middleware.js.map?rel=1451600246599