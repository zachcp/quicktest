...
return cljs.core.reduce.call(null,(function (result,p__19211){
...
var vec__19214 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__19214,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__19214,(1),null);
var ab = cljs.core.nth.call(null,vec__19214,(2),null);
...
var args19215 = [];
var len__17884__auto___19218 = arguments.length;
var i__17885__auto___19219 = (0);
while(true){
if((i__17885__auto___19219 < len__17884__auto___19218)){
args19215.push((arguments[i__17885__auto___19219]));

var G__19220 = (i__17885__auto___19219 + (1));
i__17885__auto___19219 = G__19220;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args19215.length)].join('')));
...
var m__17482__auto__ = (clojure.data.equality_partition[goog.typeOf(x__17481__auto__)]);
if(!((m__17482__auto__ == null))){
return m__17482__auto__.call(null,x);
} else {
var m__17482__auto____$1 = (clojure.data.equality_partition["_"]);
...
var x__17481__auto__ = (((a == null))?null:a);
var m__17482__auto__ = (clojure.data.diff_similar[goog.typeOf(x__17481__auto__)]);
if(!((m__17482__auto__ == null))){
return m__17482__auto__.call(null,a,b);
} else {
var m__17482__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__17482__auto____$1 == null))){
return m__17482__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__19225 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__19225) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1451600246554