...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-active","update-active",1918193808),p1__19320_SHARP_.target.value], null));
});})(molecules))
], null),(function (){var iter__17598__auto__ = ((function (molecules){
return (function drugsfromdirt$views$molecule_select_box_$_iter__19325(s__19326){
return (new cljs.core.LazySeq(null,((function (molecules){
return (function (){
var s__19326__$1 = s__19326;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__19326__$1);
if(temp__4425__auto__){
var s__19326__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__19326__$2)){
var c__17596__auto__ = cljs.core.chunk_first.call(null,s__19326__$2);
var size__17597__auto__ = cljs.core.count.call(null,c__17596__auto__);
var b__19328 = cljs.core.chunk_buffer.call(null,size__17597__auto__);
if((function (){var i__19327 = (0);
while(true){
if((i__19327 < size__17597__auto__)){
var m = cljs.core._nth.call(null,c__17596__auto__,i__19327);
cljs.core.chunk_append.call(null,b__19328,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name.call(null,m)], null),cljs.core.name.call(null,m)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),m], null)));

var G__19329 = (i__19327 + (1));
i__19327 = G__19329;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__19328),drugsfromdirt$views$molecule_select_box_$_iter__19325.call(null,cljs.core.chunk_rest.call(null,s__19326__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__19328),null);
}
} else {
var m = cljs.core.first.call(null,s__19326__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name.call(null,m)], null),cljs.core.name.call(null,m)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),m], null)),drugsfromdirt$views$molecule_select_box_$_iter__19325.call(null,cljs.core.rest.call(null,s__19326__$2)));
}
} else {
return null;
}
...
;
return iter__17598__auto__.call(null,cljs.core.deref.call(null,molecules));
})()], null);
});
;})(molecules))
});
...
var vec__19334 = cljs.core.js__GT_clj.call(null,projection.call(null,[longitude,latitude]));
var lon = cljs.core.nth.call(null,vec__19334,(0),null);
var lat = cljs.core.nth.call(null,vec__19334,(1),null);
...
var vec__19335 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__19335,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__19335,(1),null);
...
d3.json("/static/jsondata/nyc.json",((function (vec__19335,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (error,json){
return svg.append("g").attr("id","boroughs").selectAll(".state").data(json.features).enter().append("path").attr("class",((function (vec__19335,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return [cljs.core.str("borough "),cljs.core.str(d.properties.borough)].join('');
});})(vec__19335,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("d",path);
});})(vec__19335,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
);

svg.append("g").attr("id","circle").selectAll("circle").data(pointdata).enter().append("circle").attr("cx",((function (vec__19335,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lat;
});})(vec__19335,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("cy",((function (vec__19335,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lon;
});})(vec__19335,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("r",((function (vec__19335,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
...
return (function (this$){
var vec__19336 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__19336,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__19336,(1),null);
var pointdata = cljs.core.clj__GT_js.call(null,countdata__$1);
var maxradius = (function (){var maxrad = cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,((function (vec__19336,_,countdata__$1,pointdata,width,height,projection,path,getlatlon){
return (function (p1__19330_SHARP_){
return new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(p1__19330_SHARP_);
});})(vec__19336,_,countdata__$1,pointdata,width,height,projection,path,getlatlon))
,countdata__$1));
...
var svg = d3.select("#nycmap");
d3.selectAll("circle").data(pointdata).attr("r",((function (vec__19336,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__19336,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon))
);

d3.selectAll(".legend").selectAll("text").remove();

d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("circle").attr("cy",((function (vec__19336,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
return (- radius.call(null,d));
});})(vec__19336,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon))
).attr("r",((function (vec__19336,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d);
});})(vec__19336,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon))
);

return d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("text").attr("y",((function (vec__19336,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
return ((-2) * radius.call(null,d));
});})(vec__19336,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon))
).attr("dy","1.3em").text(((function (vec__19336,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
...
var latitude = new cljs.core.Keyword(null,"Latitude","Latitude",-1084128459).cljs$core$IFn$_invoke$arity$1(datamap);
var longitude = new cljs.core.Keyword(null,"Longitude","Longitude",-190132846).cljs$core$IFn$_invoke$arity$1(datamap);
var vec__19342 = cljs.core.js__GT_clj.call(null,projection.call(null,[longitude,latitude]));
var lon = cljs.core.nth.call(null,vec__19342,(0),null);
var lat = cljs.core.nth.call(null,vec__19342,(1),null);
return cljs.core.merge.call(null,datamap,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"d3lat","d3lat",-310705877),lon,new cljs.core.Keyword(null,"d3lon","d3lon",-1357422908),lat], null));
});})(width,height,projection,path))
;
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (width,height,projection,path,getlatlon){
...
,new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (width,height,projection,path,getlatlon){
return (function (this$){
var vec__19343 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__19343,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__19343,(1),null);
var countdata_updated = cljs.core.map.call(null,getlatlon,countdata__$1);
var pointdata = cljs.core.clj__GT_js.call(null,countdata_updated);
var radius = d3.scale.sqrt().domain([(0),(5)]).range([(0),(10)]);
var svg = d3.select("svg");
return d3.json("/static/jsondata/us-10m.json",((function (vec__19343,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (error,json){
svg.insert("path",".graticule").datum(topojson.feature(json,json.objects.land)).attr("class","land").attr("d",path);

svg.insert("path",".graticule").datum(topojson.mesh(json,json.objects.land,((function (vec__19343,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (a,b){
return cljs.core.not_EQ_.call(null,a,b);
});})(vec__19343,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
)).attr("class","state-boundary").attr("d",path);

svg.append("g").attr("id","circle").selectAll("circle").data(pointdata).enter().append("circle").attr("cx",((function (vec__19343,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lat;
});})(vec__19343,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("cy",((function (vec__19343,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lon;
});})(vec__19343,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("r",((function (vec__19343,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__19343,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("class","bubble");
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (width,height,projection,path,getlatlon){
return (function (this$){
var vec__19344 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__19344,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__19344,(1),null);
var pointdata = cljs.core.clj__GT_js.call(null,countdata__$1);
var maxradius = (function (){var maxrad = cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,((function (vec__19344,_,countdata__$1,pointdata,width,height,projection,path,getlatlon){
return (function (p1__19338_SHARP_){
return new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(p1__19338_SHARP_);
});})(vec__19344,_,countdata__$1,pointdata,width,height,projection,path,getlatlon))
,countdata__$1));
if(cljs.core.seq_QMARK_.call(null,maxrad)){
return cljs.core.first.call(null,maxrad);
} else {
...
d3.selectAll("circle").data(pointdata).attr("r",((function (vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);

d3.selectAll(".legend").selectAll("text").remove();

d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("circle").attr("cy",((function (vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return (- radius.call(null,d));
});})(vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
).attr("r",((function (vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d);
});})(vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);

return d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("text").attr("y",((function (vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return ((-2) * radius.call(null,d));
});})(vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
).attr("dy","1.3em").text(((function (vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return d3.format("0.01s").call(null,d);
});})(vec__19344,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);
...
var latitude = new cljs.core.Keyword(null,"Latitude","Latitude",-1084128459).cljs$core$IFn$_invoke$arity$1(datamap);
var longitude = new cljs.core.Keyword(null,"Longitude","Longitude",-190132846).cljs$core$IFn$_invoke$arity$1(datamap);
var vec__19349 = cljs.core.js__GT_clj.call(null,projection.call(null,[longitude,latitude]));
var lon = cljs.core.nth.call(null,vec__19349,(0),null);
var lat = cljs.core.nth.call(null,vec__19349,(1),null);
return cljs.core.merge.call(null,datamap,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"d3lat","d3lat",-310705877),lon,new cljs.core.Keyword(null,"d3lon","d3lon",-1357422908),lat], null));
});})(width,height,projection,path))
;
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (width,height,projection,path,getlatlon){
...
,new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (width,height,projection,path,getlatlon){
return (function (this$){
var vec__19350 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__19350,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__19350,(1),null);
var countdata_updated = cljs.core.map.call(null,getlatlon,countdata__$1);
var pointdata = cljs.core.clj__GT_js.call(null,countdata_updated);
var radius = d3.scale.sqrt().domain([(0),(5)]).range([(0),(10)]);
var svg = d3.select("svg");
return d3.json("/static/jsondata/world-50m.json",((function (vec__19350,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (error,json){
...
svg.append("g").attr("id","circle").selectAll("circle").data(pointdata).enter().append("svg:circle").attr("cx",((function (vec__19350,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lat;
});})(vec__19350,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("cy",((function (vec__19350,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lon;
});})(vec__19350,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("r",((function (vec__19350,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__19350,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("class","bubble");
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (width,height,projection,path,getlatlon){
return (function (this$){
var vec__19351 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__19351,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__19351,(1),null);
var pointdata = cljs.core.clj__GT_js.call(null,countdata__$1);
var maxradius = (function (){var maxrad = cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,((function (vec__19351,_,countdata__$1,pointdata,width,height,projection,path,getlatlon){
return (function (p1__19345_SHARP_){
return new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(p1__19345_SHARP_);
});})(vec__19351,_,countdata__$1,pointdata,width,height,projection,path,getlatlon))
,countdata__$1));
if(cljs.core.seq_QMARK_.call(null,maxrad)){
return cljs.core.first.call(null,maxrad);
} else {
...
d3.selectAll("circle").data(pointdata).attr("r",((function (vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);

d3.selectAll(".legend").selectAll("text").remove();

d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("circle").attr("cy",((function (vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return (- radius.call(null,d));
});})(vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
).attr("r",((function (vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d);
});})(vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);

return d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("text").attr("y",((function (vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return ((-2) * radius.call(null,d));
});})(vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
).attr("dy","1.3em").text(((function (vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return d3.format("0.01s").call(null,d);
});})(vec__19351,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);
...
], null),"World"], null)], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"hr","hr",1377740067)], null),(function (){var pred__19355 = cljs.core._EQ_;
var expr__19356 = cljs.core.deref.call(null,activemap);
if(cljs.core.truth_(pred__19355.call(null,"NYC",expr__19356))){
...
if(cljs.core.truth_(pred__19355.call(null,"USA",expr__19356))){
...
if(cljs.core.truth_(pred__19355.call(null,"World",expr__19356))){
...
//# sourceMappingURL=views.js.map?rel=1451600246988