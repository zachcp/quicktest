...
return (function (p1__7159_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-active","update-active",1918193808),p1__7159_SHARP_.target.value], null));
});})(molecules))
], null),(function (){var iter__5440__auto__ = ((function (molecules){
return (function drugsfromdirt$views$molecule_select_box_$_iter__7164(s__7165){
return (new cljs.core.LazySeq(null,((function (molecules){
return (function (){
var s__7165__$1 = s__7165;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__7165__$1);
if(temp__4425__auto__){
var s__7165__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__7165__$2)){
var c__5438__auto__ = cljs.core.chunk_first.call(null,s__7165__$2);
var size__5439__auto__ = cljs.core.count.call(null,c__5438__auto__);
var b__7167 = cljs.core.chunk_buffer.call(null,size__5439__auto__);
if((function (){var i__7166 = (0);
while(true){
if((i__7166 < size__5439__auto__)){
var m = cljs.core._nth.call(null,c__5438__auto__,i__7166);
cljs.core.chunk_append.call(null,b__7167,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name.call(null,m)], null),cljs.core.name.call(null,m)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),m], null)));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7167),drugsfromdirt$views$molecule_select_box_$_iter__7164.call(null,cljs.core.chunk_rest.call(null,s__7165__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7167),null);
}
} else {
var m = cljs.core.first.call(null,s__7165__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name.call(null,m)], null),cljs.core.name.call(null,m)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),m], null)),drugsfromdirt$views$molecule_select_box_$_iter__7164.call(null,cljs.core.rest.call(null,s__7165__$2)));
}
} else {
return null;
}
...
var vec__7173 = cljs.core.js__GT_clj.call(null,projection.call(null,[longitude,latitude]));
var lon = cljs.core.nth.call(null,vec__7173,(0),null);
var lat = cljs.core.nth.call(null,vec__7173,(1),null);
...
var vec__7174 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__7174,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__7174,(1),null);
...
d3.json("/static/jsondata/nyc.json",((function (vec__7174,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (error,json){
return svg.append("g").attr("id","boroughs").selectAll(".state").data(json.features).enter().append("path").attr("class",((function (vec__7174,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return [cljs.core.str("borough "),cljs.core.str(d.properties.borough)].join('');
});})(vec__7174,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("d",path);
});})(vec__7174,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
);

svg.append("g").attr("id","circle").selectAll("circle").data(pointdata).enter().append("circle").attr("cx",((function (vec__7174,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lat;
});})(vec__7174,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("cy",((function (vec__7174,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lon;
});})(vec__7174,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("r",((function (vec__7174,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
...
return (function (this$){
var vec__7175 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__7175,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__7175,(1),null);
var pointdata = cljs.core.clj__GT_js.call(null,countdata__$1);
var maxradius = (function (){var maxrad = cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,((function (vec__7175,_,countdata__$1,pointdata,width,height,projection,path,getlatlon){
return (function (p1__7169_SHARP_){
return new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(p1__7169_SHARP_);
});})(vec__7175,_,countdata__$1,pointdata,width,height,projection,path,getlatlon))
,countdata__$1));
...
var svg = d3.select("#nycmap");
d3.selectAll("circle").data(pointdata).attr("r",((function (vec__7175,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__7175,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon))
);

d3.selectAll(".legend").selectAll("text").remove();

d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("circle").attr("cy",((function (vec__7175,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
return (- radius.call(null,d));
});})(vec__7175,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon))
).attr("r",((function (vec__7175,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d);
});})(vec__7175,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon))
);

return d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("text").attr("y",((function (vec__7175,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
return ((-2) * radius.call(null,d));
});})(vec__7175,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon))
).attr("dy","1.3em").text(((function (vec__7175,_,countdata__$1,pointdata,maxradius,radius,legend_data,svg,width,height,projection,path,getlatlon){
return (function (d){
...
var latitude = new cljs.core.Keyword(null,"Latitude","Latitude",-1084128459).cljs$core$IFn$_invoke$arity$1(datamap);
var longitude = new cljs.core.Keyword(null,"Longitude","Longitude",-190132846).cljs$core$IFn$_invoke$arity$1(datamap);
var vec__7180 = cljs.core.js__GT_clj.call(null,projection.call(null,[longitude,latitude]));
var lon = cljs.core.nth.call(null,vec__7180,(0),null);
var lat = cljs.core.nth.call(null,vec__7180,(1),null);
return cljs.core.merge.call(null,datamap,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"d3lat","d3lat",-310705877),lon,new cljs.core.Keyword(null,"d3lon","d3lon",-1357422908),lat], null));
});})(width,height,projection,path))
;
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (width,height,projection,path,getlatlon){
...
,new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (width,height,projection,path,getlatlon){
return (function (this$){
var vec__7181 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__7181,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__7181,(1),null);
var countdata_updated = cljs.core.map.call(null,getlatlon,countdata__$1);
var pointdata = cljs.core.clj__GT_js.call(null,countdata_updated);
var radius = d3.scale.sqrt().domain([(0),(5)]).range([(0),(10)]);
var svg = d3.select("svg");
return d3.json("/static/jsondata/us-10m.json",((function (vec__7181,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (error,json){
svg.insert("path",".graticule").datum(topojson.feature(json,json.objects.land)).attr("class","land").attr("d",path);

svg.insert("path",".graticule").datum(topojson.mesh(json,json.objects.land,((function (vec__7181,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (a,b){
return cljs.core.not_EQ_.call(null,a,b);
});})(vec__7181,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
)).attr("class","state-boundary").attr("d",path);

svg.append("g").attr("id","circle").selectAll("circle").data(pointdata).enter().append("circle").attr("cx",((function (vec__7181,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lat;
});})(vec__7181,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("cy",((function (vec__7181,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lon;
});})(vec__7181,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("r",((function (vec__7181,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__7181,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("class","bubble");
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (width,height,projection,path,getlatlon){
return (function (this$){
var vec__7182 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__7182,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__7182,(1),null);
var pointdata = cljs.core.clj__GT_js.call(null,countdata__$1);
var maxradius = (function (){var maxrad = cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,((function (vec__7182,_,countdata__$1,pointdata,width,height,projection,path,getlatlon){
return (function (p1__7176_SHARP_){
return new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(p1__7176_SHARP_);
});})(vec__7182,_,countdata__$1,pointdata,width,height,projection,path,getlatlon))
,countdata__$1));
if(cljs.core.seq_QMARK_.call(null,maxrad)){
return cljs.core.first.call(null,maxrad);
} else {
...
d3.selectAll("circle").data(pointdata).attr("r",((function (vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);

d3.selectAll(".legend").selectAll("text").remove();

d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("circle").attr("cy",((function (vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return (- radius.call(null,d));
});})(vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
).attr("r",((function (vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d);
});})(vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);

return d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("text").attr("y",((function (vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return ((-2) * radius.call(null,d));
});})(vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
).attr("dy","1.3em").text(((function (vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return d3.format("0.01s").call(null,d);
});})(vec__7182,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);
...
var latitude = new cljs.core.Keyword(null,"Latitude","Latitude",-1084128459).cljs$core$IFn$_invoke$arity$1(datamap);
var longitude = new cljs.core.Keyword(null,"Longitude","Longitude",-190132846).cljs$core$IFn$_invoke$arity$1(datamap);
var vec__7187 = cljs.core.js__GT_clj.call(null,projection.call(null,[longitude,latitude]));
var lon = cljs.core.nth.call(null,vec__7187,(0),null);
var lat = cljs.core.nth.call(null,vec__7187,(1),null);
return cljs.core.merge.call(null,datamap,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"d3lat","d3lat",-310705877),lon,new cljs.core.Keyword(null,"d3lon","d3lon",-1357422908),lat], null));
});})(width,height,projection,path))
;
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (width,height,projection,path,getlatlon){
...
,new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (width,height,projection,path,getlatlon){
return (function (this$){
var vec__7188 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__7188,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__7188,(1),null);
var countdata_updated = cljs.core.map.call(null,getlatlon,countdata__$1);
var pointdata = cljs.core.clj__GT_js.call(null,countdata_updated);
var radius = d3.scale.sqrt().domain([(0),(5)]).range([(0),(10)]);
var svg = d3.select("svg");
return d3.json("/static/jsondata/world-50m.json",((function (vec__7188,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (error,json){
...
svg.append("g").attr("id","circle").selectAll("circle").data(pointdata).enter().append("svg:circle").attr("cx",((function (vec__7188,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lat;
});})(vec__7188,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("cy",((function (vec__7188,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return d.d3lon;
});})(vec__7188,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("r",((function (vec__7188,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__7188,_,countdata__$1,countdata_updated,pointdata,radius,svg,width,height,projection,path,getlatlon))
).attr("class","bubble");
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (width,height,projection,path,getlatlon){
return (function (this$){
var vec__7189 = reagent.core.argv.call(null,this$);
var _ = cljs.core.nth.call(null,vec__7189,(0),null);
var countdata__$1 = cljs.core.nth.call(null,vec__7189,(1),null);
var pointdata = cljs.core.clj__GT_js.call(null,countdata__$1);
var maxradius = (function (){var maxrad = cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,((function (vec__7189,_,countdata__$1,pointdata,width,height,projection,path,getlatlon){
return (function (p1__7183_SHARP_){
return new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(p1__7183_SHARP_);
});})(vec__7189,_,countdata__$1,pointdata,width,height,projection,path,getlatlon))
,countdata__$1));
if(cljs.core.seq_QMARK_.call(null,maxrad)){
return cljs.core.first.call(null,maxrad);
} else {
...
d3.selectAll("circle").data(pointdata).attr("r",((function (vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d.size);
});})(vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);

d3.selectAll(".legend").selectAll("text").remove();

d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("circle").attr("cy",((function (vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return (- radius.call(null,d));
});})(vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
).attr("r",((function (vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return radius.call(null,d);
});})(vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);

return d3.selectAll(".legend").selectAll("g").data(legend_data).enter().append("text").attr("y",((function (vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return ((-2) * radius.call(null,d));
});})(vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
).attr("dy","1.3em").text(((function (vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon){
return (function (d){
return d3.format("0.01s").call(null,d);
});})(vec__7189,_,countdata__$1,pointdata,maxradius,radius,legend_data,width,height,projection,path,getlatlon))
);
...
], null),"World"], null)], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"hr","hr",1377740067)], null),(function (){var pred__7193 = cljs.core._EQ_;
var expr__7194 = cljs.core.deref.call(null,activemap);
if(cljs.core.truth_(pred__7193.call(null,"NYC",expr__7194))){
...
if(cljs.core.truth_(pred__7193.call(null,"USA",expr__7194))){
...
if(cljs.core.truth_(pred__7193.call(null,"World",expr__7194))){
...
//# sourceMappingURL=views.js.map?rel=1451600276746