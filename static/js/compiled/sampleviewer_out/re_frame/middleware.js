...
var G__7127__i = 0, G__7127__a = new Array(arguments.length -  0);
while (G__7127__i < G__7127__a.length) {G__7127__a[G__7127__i] = arguments[G__7127__i + 0]; ++G__7127__i;}
  args = new cljs.core.IndexedSeq(G__7127__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__7128){
var args = cljs.core.seq(arglist__7128);
...
return cljs.core.get_in.call(null,new_db,p1__7129_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__7130_SHARP_){
return cljs.core.get_in.call(null,db,p1__7130_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__7131__i < G__7131__a.length) {G__7131__a[G__7131__i] = arguments[G__7131__i + 2]; ++G__7131__i;}
  in_paths = new cljs.core.IndexedSeq(G__7131__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__7132){
var f = cljs.core.first(arglist__7132);
arglist__7132 = cljs.core.next(arglist__7132);
var out_path = cljs.core.first(arglist__7132);
var in_paths = cljs.core.rest(arglist__7132);
...
//# sourceMappingURL=middleware.js.map?rel=1451600276555